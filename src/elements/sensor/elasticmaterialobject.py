# -*- coding: utf-8 -*-
"""
Copy-paste from the elasticmaterialobject.py file in the stlib3 repository to fix a bug.
"""
...
class ElasticMaterialObject(Sofa.Prefab):
    ...
    prefabParameters = [
        {
            "name": "volumeMeshFileName",
            "type": "string",
            "help": "Path to volume mesh file",
            "default": "",
        },
        {
            "name": "rotation",
        ...
        {
            "name": "surfaceMeshFileName",
            "type": "string",
            "help": "Path to surface mesh file",
            "default": "",
        },
        {
            "name": "collisionMesh",
            "type": "string",
            "help": "Path to collision mesh file",
            "default": "",
        },
        {
            "name": "withConstrain",
            "type": "bool",
            "help": "Add constraint correction",
            "default": True,
        },
        {
            "name": "surfaceColor",
            "type": "Vec4d",
            "help": "Color of surface mesh",
    ...
    def init(self):
        ...
        self.mass = self.addObject(
            "UniformMass", totalMass=self.totalMass.value, name="mass"
        )
        ...
        if self.withConstrain.value:
            self.correction = self.addObject(
                "LinearSolverConstraintCorrection", name="correction"
            )
    ...
    def addVisualModel(
        self, filename, color, rotation, translation, scale=[1.0, 1.0, 1.0]
    ):
